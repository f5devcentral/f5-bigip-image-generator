...
class BuildInfo:
    ...
    package_manager_commands = {
        ...
        # 'ossutil --version' output example: 'ossutil version: 1.4.2'
        "ossutil": ("ossutil --version", r"(^ossutil)\sversion:\s(.*)"),
...
def get_standalone_software():
    ...
    # ossutil
    ossutil_command = BuildInfo.package_manager_commands["ossutil"]
    standalone_software.update(_command_key_values_to_dict(*ossutil_command))
